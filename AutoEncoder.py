...
class NeuralNet:
    def __init__(self, X, y, **kwargs):
        ...
        self.model = Model(input_x, self.autoencoder(input_x))
    ...
    def autoencoder(self, input_cov):
        # encoder
        encoded1 = Dense(600, activation='relu')(input_cov)
        encoded2 = Dense(300, activation='relu')(encoded1)
        encoded3 = Dense(100, activation='relu')(encoded2)
        coded = Dense(1, activation='relu', )(encoded3)
        decoded1 = Dense(100, activation='relu')(coded)
        decoded2 = Dense(300, activation='relu')(decoded1)
        decoded3 = Dense(600, activation='relu')(decoded2)
        decoded_out = Dense(1048, activation='relu')(decoded3)
